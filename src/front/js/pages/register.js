          ...
          <form className="px-md-5">
            <div className="col-lg-12 mb-4 ">
              <div className="Container-Input">
                ...
                />
                <label>Username</label>{errors.username && (
                <span  data-tip data-for="Tooltip1" className="FloatIcon btn"><i className="fa-solid fa-delete-left"></i> 
                <ReactTooltip id="Tooltip1" place="top" textColor="white" backgroundColor="black">Inválido: 5-20 caracteres (letras, numeros y . _), 
                sin . o _ al final o al principio</ReactTooltip> </span>
              )}
              </div>
              ...
              <div className="Container-Input mt-5">
                ...
                <label>Email</label>
                {errors.email && (
                <span  data-tip data-for="Tooltip2" className="FloatIcon btn"><i className="fa-solid fa-delete-left"></i> 
                <ReactTooltip id="Tooltip2" place="top" textColor="white" backgroundColor="black">Correo electrónico inválido</ReactTooltip> </span>
              )}
              </div>
              ...
              <div className="Container-Input mt-5">
                <div className="input-btn">
                  ...
                  {errors.password && (
                            <span  data-tip data-for="Tooltip3" className="FloatIcon btn"><i className="fa-solid fa-delete-left"></i> 
                            <ReactTooltip id="Tooltip3" place="top" textColor="white" backgroundColor="black">Tu contraseña debe tener: 8
                          caracteres, 1 letra minúscula, 1 letra mayúscula,
                          1 número y 1 caracter especial.</ReactTooltip> </span>
                          )}
                </div>
              </div>
              ...
              <div className="Container-Input mt-5">
                ...
                {errors.confirmPassword && (
                            <span  data-tip data-for="Tooltip4" className="FloatIcon btn"><i className="fa-solid fa-delete-left"></i> 
                            <ReactTooltip id="Tooltip4" place="top" textColor="white" backgroundColor="black">Contraseña distinta, intente otra vez</ReactTooltip> </span>
                          )}
              </div>
